...
import { shareRouter, publicShareRouter } from "./routes/share.route.js";
import { ensureConfigInitialized } from "./utils/solana/index.js";
import { securityHeaders, publicShareCors } from "./middlewares/security.middleware.js";
...
app.use("/api/public/share", cors(publicShareCors), publicShareRouter);
