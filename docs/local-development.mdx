...
description: 'Set up Keep locally for contributing'
---

<Info>
  This guide is for contributors who want to run Keep locally for development. If you just want to use Keep, check out the [Quickstart](/quickstart) guide.
</Info>
