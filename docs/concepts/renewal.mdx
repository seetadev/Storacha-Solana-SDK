...
When you upload files with Keep, you specify a storage duration (e.g., 30 days). After this period:
...
Keep sends automatic email reminders to help you avoid data loss:
