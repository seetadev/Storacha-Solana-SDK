---
title: 'Quickstart'
description: 'Get started with Keep in 5 minutes'
---
...
Want to contribute to Keep? Check out the [Local Development Guide](/local-development) to set up the project on your machine.
